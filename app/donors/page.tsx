            ...
            donors.map((donor, index) => (
              ...
              >
                ...
                <div className="ml-0 md:ml-6 mt-4 md:mt-0 flex-1 text-center md:text-left">
                  ...
                  <p><strong className="text-[#C1272D]">Blood Group:</strong> <span className="text-[#F8F9FA]">{donor.bloodGroup}</span></p>
                  <p><strong className="text-[#C1272D]">Location:</strong> <span className="text-[#F8F9FA]">{donor.location}</span></p>
                  <p><strong className="text-[#C1272D]">Last Donation Date:</strong> <span className="text-[#F8F9FA]">{donor.lastDonationDate}</span></p>
                </div>
